...
The code in this repository is a project that follows the key tenets of data science (see below), in order to uphold its reproducibility and academic integrity. 
